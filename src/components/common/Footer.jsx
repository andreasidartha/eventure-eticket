      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="space-y-4">
            ...
            <p className="text-gray-400">Your modern solution for event ticketing. Fast, simple, and beautiful.</p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/events" className="text-gray-400 hover:text-white">All Events</Link></li>
          ...
          <div>
            ...
            <p className="text-gray-400 mb-4">Stay updated with our latest events.</p>
            <form className="flex">
